...
public class SpringBatchQuartzSchedulerTest extends QuartzJobBean 
{
	...
	public static void main(String[] args) throws Throwable 
	{
		...
		ApplicationContext context =
				new ClassPathXmlApplicationContext("batch/quartz-scheduled-batch.xml","applicationContext.xml");
